 ...
 * set per window via {@link NativeApplicationConfiguration} and {@link NativeWindowConfiguration}. Close events can be canceled
 * by returning false.
 *
 * @author badlogic
 */
public interface NativeWindowListener {
    ...
    /**
     * Called after the GLFW window is created. Before this callback is received, it's unsafe to use any {@link NativeWindow}
     ...
     * {@link NativeApplication#NativeApplication(ApplicationListener, NativeApplicationConfiguration)}.
     *
     * @param window the window instance
     * @see NativeApplication#newWindow(ApplicationListener, NativeWindowConfiguration)
     */
    void created(NativeWindow window);
     ...
     * {@link NativeGraphics#requestRendering()} is automatically called.
     */

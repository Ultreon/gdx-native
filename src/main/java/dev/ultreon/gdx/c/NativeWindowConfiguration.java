...
import static dev.ultreon.gdx.c.NativeGraphics.*;

public class NativeWindowConfiguration {
    int windowX = -1;
    int windowY = -1;
    int windowWidth = 640;
    ...
    public void setMaximizedMonitor(Graphics.Monitor monitor) {
        this.maximizedMonitor = (NativeMonitor) monitor;
    }
    ...
    /**
     * Sets the {@link NativeWindowListener} which will be informed about iconficiation, focus loss and window close events.
     */
    ...
    /**
     * Sets the app to use fullscreen mode. Use the static methods like {@link NativeApplicationConfiguration#getDisplayMode()} on
    ...
    public void setFullscreenMode(DisplayMode mode) {
        this.fullscreenMode = (NativeGraphics.NativeDisplayMode) mode;
    }

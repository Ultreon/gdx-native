...
//
///** @author Nathan Sweet */
//public class OpenALNativeAudio implements NativeAudio {
...
//
//	public OpenALNativeAudio() {
//		this(16, 9, 512);
//	}
//
//	public OpenALNativeAudio(int simultaneousSources, int deviceBufferCount, int deviceBufferSize) {
...
//		try {
//			OpenALSound sound = soundClass.getConstructor(new Class[] {OpenALNativeAudio.class, FileHandle.class}).newInstance(this,
//				file);
...
//		try {
//			return musicClass.getConstructor(new Class[] {OpenALNativeAudio.class, FileHandle.class}).newInstance(this, file);
//		} catch (Exception ex) {

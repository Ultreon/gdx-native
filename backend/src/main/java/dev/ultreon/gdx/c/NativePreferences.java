...
public class NativePreferences implements Preferences {
    private final Properties properties = new Properties();
    private final FileHandle file;

    public NativePreferences(String name, String directory) {
        this(new NativeFileHandle(new File(directory, name), FileType.External));
    }

    public NativePreferences(FileHandle file) {
        this.file = file;

...
public class DefaultNativeInput extends AbstractInput implements NativeInput {
    ...
    private final GLFWKeyCallback keyCallback = Function.get(GLFWKeyCallback.class, DefaultNativeInput.class, "keyCallback");

    GLFWCharCallback charCallback = Function.get(GLFWCharCallback.class, DefaultNativeInput.class, "charCallback");
    int pressedKeyCount;
    ...
    public DefaultNativeInput(NativeWindow window) {
        this.window = window;
